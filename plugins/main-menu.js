 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: ` Info Bot`, rowId: ".info", description: "Info Fahlevi BOT"},
	...
	{title: ` Bot Stats`, rowId: ".botinfo", description: "Menampilkan Status"},
	...
	rows: [
	    ...
	    {title: `『 Get Hadiah 』`, rowId: ".daily", description: 'Mau hadiah?'},
	{title: `『 Rating 』`, rowId: ".rate", description: 'Jangan kasih rate rendah don'},
	...
	{title: `〚 Downloader 〛-𐑂`, rowId: ".? downloader", description: "╰► Jangan download yg aneh-aneh"},
...
*/
	...
	return conn.sendButton(m.chat, '.', text, img2, [["SEWA BOT", _p + "sewabot"], ["SCRIPT", _p + "sc"], ["OWNER", _p + "owner"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: "https://instagram.com/fhlvi.__",
                mediaType: "VIDEO",
                title: `Hallo ${name} ${ucpn}`,
                body: 'Remake By Fahlevi ',
                previewType: 0,
                thumbnail: img
            }
        }
